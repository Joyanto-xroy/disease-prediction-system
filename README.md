...
- **PDF Document Generation**: Download professional prescriptions and medical reports
...
The application will automatically start both the web server and the disease prediction service.
